...
if solvable(root):
    ...
    time1 = time()
    BFS_solution = BFS(root, int(math.sqrt(n+1)))
    BFS_time = time() - time1
    ...
    time2 = time()
    DFS_solution = DFS(root, int(math.sqrt(n+1)))
    DFS_time = time() - time2
    ...
    time3 = time()
    Greedy_solution = Greedy(root, int(math.sqrt(n+1)))
    ...
    time4 = time()
    AStar_solution = AStar_search(root, int(math.sqrt(n+1)))
